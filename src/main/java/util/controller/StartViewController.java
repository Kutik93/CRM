...
import util.service.PersonCustomerRegistration;
import util.service.RegisterPersoForm;
...
public class StartViewController {
    ...
    public void onPersonSave(ActionEvent event) {
        ...
        final var form = new RegisterPersoForm(firstNameText, lastNameText, peselText);
